...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Thu Jan 11 15:06:32 CET 2024
...
set_load -pin_load 1.0 [get_ports controller_latch]
set_load -pin_load 1.0 [get_ports controller_clk]
set_load -pin_load 1.0 [get_ports Vsync]
set_load -pin_load 1.0 [get_ports Hsync]
set_load -pin_load 1.0 [get_ports {R_data[3]}]
set_load -pin_load 1.0 [get_ports {R_data[2]}]
set_load -pin_load 1.0 [get_ports {R_data[1]}]
set_load -pin_load 1.0 [get_ports {R_data[0]}]
set_load -pin_load 1.0 [get_ports {G_data[3]}]
set_load -pin_load 1.0 [get_ports {G_data[2]}]
set_load -pin_load 1.0 [get_ports {G_data[1]}]
set_load -pin_load 1.0 [get_ports {G_data[0]}]
set_load -pin_load 1.0 [get_ports {B_data[3]}]
set_load -pin_load 1.0 [get_ports {B_data[2]}]
set_load -pin_load 1.0 [get_ports {B_data[1]}]
set_load -pin_load 1.0 [get_ports {B_data[0]}]
...
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports p1_controller]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports p2_controller]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports controller_latch]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports controller_clk]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports Vsync]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports Hsync]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {R_data[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {R_data[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {R_data[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {R_data[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {G_data[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {G_data[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {G_data[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {G_data[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {B_data[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {B_data[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {B_data[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {B_data[0]}]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports p1_controller]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports p2_controller]
